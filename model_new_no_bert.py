"""
New text matching model without BERT dependency.
"""
import torch
...
class NewTextMatchModelNoBert(nn.Module):
...
def create_new_no_bert_model():
    model = NewTextMatchModelNoBert(
    ...
    print("   特性: Residual/LayerNorm + 对比学习接口")

    return model


if __name__ == "__main__":
    model = create_new_no_bert_model()
